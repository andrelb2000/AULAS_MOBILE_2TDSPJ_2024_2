...
class MainActivity : AppCompatActivity() {
    ...
    private var listaRecuperada:ArrayList<Peca>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inicializacao()
        var pacoteChecada: Bundle? = intent.extras
        if (intent.extras !=null){
            listaPecas = pacoteChecada?.getSerializable("LISTA") as ArrayList<Peca>
            adaptador = ArrayAdapter<Peca>(this,android.R.layout.simple_list_item_1, listaPecas!!)
            listaPecasView?.adapter = adaptador
        }
    }
    ...
    override fun onSaveInstanceState(outState: Bundle, outPersistentState: PersistableBundle) {
        ...
        print("Salvando")
        outState.putSerializable("LISTA",listaPecas)
    }
}